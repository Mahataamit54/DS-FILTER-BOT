...
# Bot information
SESSION = environ.get('SESSION', 'DS_MOVIES_BOT')
API_ID = int(environ.get('API_ID', '25933625'))
API_HASH = environ.get('API_HASH', '9f27c4fac7efd9040e9d8648c33cc513')
BOT_TOKEN = environ.get('BOT_TOKEN', "7598520229:AAFHOZvFPEx4gD3l5xeJWY-0LklFvOF0oGE")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://imdevops.in/assets/20250425_225926.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5798778089').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002525688849'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002554168902').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002662342662') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devops:Devops@123456@dsmoviesbot.pdvu8xn.mongodb.net/?retryWrites=true&w=majority&appName=dsmoviesbot")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "dsmoviesbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Dscollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://imdevops.in/assets/qr_code_placeholder.png') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ds_network_disscussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/backup_movies_channel')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ds_network_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/member_adder_paid')
