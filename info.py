...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1001430096044 -1001333530197 ').split()]  # For Multiple Id Use One Space Between Each.
