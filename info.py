...
BOT_TOKEN = environ.get('BOT_TOKEN', "8004189992:AAGs6IIwCkBYiaLsK4sCk0_X-QYy6r_CNfk")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002400301222 -1002694413958').split()]  # For Multiple Id Use One Space Between Each.
