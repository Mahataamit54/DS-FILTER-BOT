...
API_HASH = environ.get('API_HASH', '461969be0f5af13fc50a55f6e783d6c8')
BOT_TOKEN = environ.get('BOT_TOKEN', "8117068687:AAHUtmoz8_qGzC33ESY9TKHp8uRe1_pVT8g 8004189992:AAGs6IIwCkBYiaLsK4sCk0_X-QYy6r_CNfk")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/rzJ.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', ' 8087950004').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002583763985'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002649891246 -1002694413958').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mahataamit:mahataamit@cluster0.kjtl4dc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+KWR-ZQ5kKVIxNmY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+LCSCKnUSqWA0Zjll')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+TzSjKRlLubkxNmVl') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/@Amit72051')
